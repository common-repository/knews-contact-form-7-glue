...
Add a Knews subscription field to your Contact Form 7 forms
...
3. Add a new CF7 form or edit one, use the Generate Tag assistant and select **Knews Subscription**

4. Configure the options and add the code. Save.


== Screenshots ==

1. The Tag Assistant selection.
2. After set the configuration, copy and paste the TAG and Save the form.
3. The form has the subscription checkbox.
...
= 1.0.2 =
- Support for the new CF7 4.6: some functions has been deprecated)

= 1.0.1 =
- Support for the new CF7 4.2 release: new interface form editor with ADD code button.
- Solve the 4.2+ blank pupup
- New advice added: When there isn't any newsletter selected, or it's closed to new subscriptions, 
  a message will shown on the form front-end for users who can edit posts.
